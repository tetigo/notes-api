...
```
cd existing_repo
git remote add origin https://gitlab.com/technical-home-assessment1/Property-Rental.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/technical-home-assessment1/Property-Rental/-/settings/integrations)
